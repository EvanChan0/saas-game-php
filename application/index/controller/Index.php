...
class Index extends Frontend
{
    ...
    public function index() {
        ...
        //         // 准备请求参数
                ...
                // 发起POST请求
                $ch = curl_init();
                curl_setopt($ch, CURLOPT_URL, "https://sa.api-bet.net/api/server/gameCode"); // 替换为实际的接口URL
                ...
                foreach ($responseData['data'] as $value) {
                    ...
                    if(!isset($value['imageUrl']['en']['circle'])){
                     continue;
                    }else{
                      $datas['imageUrl']=$value['imageUrl']['en']['circle'];
                    }
                    dump($datas);
