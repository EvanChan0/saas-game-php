...
class User extends Api
{
    ...
    */
    public function register() {
        ...
        if (filter_var($username, FILTER_VALIDATE_EMAIL)) {
            ...
            // dump($retsm);die; 
            if ($retsm !== $code) {
                $this->error('Erro no código de verificação de e-mail');
            }
        } else {
    ...
    */
    public function change_pwd() {
         ...
         $code = $this->request->request('codes');
         
         
        $ems=db::name("ems")->where(['email' => $mobile])->order("id desc")->find();
